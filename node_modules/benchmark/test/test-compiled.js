...
;(function (window, undefined) {
  ...
  (function () {
    ...
    test('supports passing an options object', function () {
      var bench = Benchmark({ 'name': 'foo', 'fn': function fn() {} });
    ...
    test('supports passing a "name" argument and an options object', function () {
      var bench = Benchmark('foo', { 'fn': function fn() {} });
      ok(bench.fn && bench.name == 'foo');
    });
  ...
  (function () {
    ...
    var tests = {
      ...
      'called "fn" and inlined "setup"/"teardown" reached by error': function calledFnAndInlinedSetupTeardownReachedByError() {
        count++;
        if (/ops/.test(this)) {
          this._fn = true;
        }
      },
      'called "fn" and inlined "setup"/"teardown" reached by `return` statement': function calledFnAndInlinedSetupTeardownReachedByReturnStatement() {
        if (/ops/.test(this)) {
          this._fn = true;
        }
        return;
  ...
  (function () {
    ...
    test('doesn\'t use an object\'s `hasOwnProperty` method', function () {
      var object = { 'hasOwnProperty': function hasOwnProperty() {
          return true;
        } };
  ...
  forOwn({
    ...
    (function () {
      ...
      test('uses a shallow clone of the listeners when emitting', function () {
        var event,
            listener2 = function listener2(eventObject) {
...
})(typeof global == 'object' && global || undefined);
